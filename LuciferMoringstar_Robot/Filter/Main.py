...
async def filter(client, message):
    ...
    if 2 < len(message.text) < 100:    
        btn = []
        search = message.text
        mo_tech_yt = f"**🗂️ <b>Title</b>:** {search}\n**🌟 <b>Rating</b>:** {random.choice(RATING)}\n**🎭 <b>Genre</b>:** {random.choice(GENRES)}\n**🗳️ <b>Uploaded By</b>: {message.chat.title}**"
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if (clicked == typed):
        ...
        if query.data.startswith("next"):
            ...
            buttons = [[
                InlineKeyboardButton('💠 𝗝𝗼𝗶𝗻 𝗖𝗵𝗮𝗻𝗻𝗲𝗹 💠', url='t.me/Minnal_Murali2021HD'),
            ...
            buttons = [
                [
                    InlineKeyboardButton('♻️ 𝗝𝗼𝗶𝗻 𝗖𝗵𝗮𝗻𝗻𝗲𝗹 ♻️', url='t.me/Minnal_Murali2021HD'),
